...
def main():
    ...
    scan_parser.add_argument("path", type=str, help="Path to Solidity file or directory")
    ...
    scan_parser.add_argument(
        "--critical-only", action="store_true", help="Only show CRITICAL and HIGH severity findings"
    )

    # Score command
    score_parser = subparsers.add_parser("score", help="Calculate security score")
    score_parser.add_argument("path", type=str, help="Path to Solidity file")
